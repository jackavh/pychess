...
# TODO: Move inside __init__ for DisplayPiece
...
# TODO: Fix undefined variables from creating cfg.py
...
class Display(arcade.Window):
    ...
    def move_piece(self, start: int, end: int):
        if self.piece_sprites[end] is None:
            self.
    ...
    def on_mouse_motion(self, x, y, delta_x, delta_y):
        ...
        self.hover_square_idx = xy_to_flat(hx, hy)
